            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table style="width: 100%; border-style:double; margin-top:20px; border-collapse:collapse;">
                        ...
                        <!-- thông tin -->
                        <?php
                        $sql = "SELECT*FROM bill ORDER BY timestamp DESC LIMIT $per_row,$row_per_page";
                        ...
                        ?>
                            <tr>
                                ...
                                <th style="border-style:double; border-collapse:collapse; text-align:center">
                                    <a onclick="return bill('<?php echo $row['id']; ?>')" href="index.php?page_layout=xuly&&status=<?php echo $st_next; ?>&&id=<?php echo $row['id']; ?>"><?php if ($row['status'] == 2) {
