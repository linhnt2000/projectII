        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a onclick="return del('<?php echo $row['comm_id']; ?>')" href="del_comment.php?comm_id=<?php echo $row['comm_id'];?>" class="btn btn-danger"> Xóa</a>
                                </td>
                            </tr>
                            <?php
                            }
                	...
                	<!-- Xuat excel -->
				<form style="margin-left: 15px; margin-bottom: 7px;" method="post" action="export/comm_export.php">
